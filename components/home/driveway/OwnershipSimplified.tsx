      ...
      <div className="mx-auto grid max-w-[1200px] items-center gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="order-1 lg:order-2">
          ...
          <Reveal delay={0.15}>
            <Link
              href="/service"
              className="inline-flex h-[52px] items-center justify-center rounded-full border-2 border-[#00af66] bg-[#00af66] px-10 text-[16px] font-semibold text-white transition-transform duration-300 hover:scale-[1.03] hover:opacity-90"
            >
              Join Carma Credit
            </Link>
          </Reveal>
