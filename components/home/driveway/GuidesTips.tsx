  ...
  return (
    <section className="dw-font flex w-full flex-col items-center bg-[#F5F5F5] px-4 py-12 sm:px-6 md:px-10 md:py-16 xl:px-[72px] xl:py-24">
      ...
      <Reveal delay={0.15} className="mt-8 flex w-full justify-center md:mt-10 xl:mt-12">
        <Link
          href="/about-us"
          className="inline-flex h-12 cursor-pointer items-center justify-center rounded-full bg-[#1451B5] px-8 text-[16px] font-semibold leading-none text-white no-underline transition-transform duration-300 hover:scale-[1.03] hover:bg-[#104191]"
        >
          Read More Articles
        </Link>
      </Reveal>
