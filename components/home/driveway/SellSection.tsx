...
const SellSection = () => {
  return (
    <section className="dw-font w-full bg-[#007aff] px-4 py-10 sm:px-6 sm:py-12 lg:px-16 lg:pb-8 lg:pt-12 xl:px-[120px]">
      <div className="mx-auto flex max-w-[1100px] flex-col items-stretch gap-8 sm:gap-10 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
        <Reveal className="flex w-full max-w-[560px] flex-col items-start justify-center text-left lg:flex-1 lg:max-w-none" x={-24}>
          <h2 className="mb-3 w-full whitespace-nowrap text-left text-[clamp(1.5rem,4.6vw,3.25rem)] font-bold leading-tight text-white sm:mb-4">
            What’s my car worth?
          </h2>
