  ...
  return (
    <div className="w-full max-w-[550px] flex justify-center rounded-[10px] lg:mt-4 lg:pt-2 bg-prequalify-blue relative z-40">
      <div className="rounded-[10px] p-4 lg:p-[30px_25px_18px] w-full">
        ...
        <Link
          href={`/inventory/`}
          className="block text-center text-white font-medium text-base w-full hover:opacity-90 transition-opacity rounded-full border-2 border-brand py-3 px-[30px] bg-brand-btn-gradient"
        >
          Browse all Cars
        </Link>
