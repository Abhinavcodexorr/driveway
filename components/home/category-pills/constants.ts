...
export const PILL_CLASS = "my-5 flex items-center px-9 gap-[0.5px] rounded-full border-2 border-brand2 bg-white py-4 text-brand2 font-medium text-base justify-center hover:bg-brand-btn-gradient hover:text-white transition-all duration-200 snap-start shrink-0";
