        ...
        {!isSold && (
          <div className="w-full rounded-[12px] mb-3 px-3 mt-auto flex gap-1">
            ...
            <button
              ...
              className="cursor-pointer w-44 text-center rounded-full text-white py-[10px] text-[14px] sm:text-[15px] font-medium hover:opacity-90 transition-opacity bg-brand border-2 border-brand-green2"
            >
              Check availability
            </button>
          </div>
